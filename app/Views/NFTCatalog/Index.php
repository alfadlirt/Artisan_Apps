...
<?= $this->section('content'); ?>
    <div class="page-title-box">
        <div class="row align-items-center ">
            <div class="col-md-8">
                <div class="page-title-box">
                    <h4 class="page-title">NFTCatalog</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0);">Heraio Admin</a>
                        </li>
                        <li class="breadcrumb-item active">NFTCatalog</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                <form method="GET" action="<?=base_url('NFTCatalog/index');?>">
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    <div class="row" style="margin-top:50px">
                        <div class="col-md-3">
                            <a href="<?= base_url('NFTCatalog/New') ?>" class="btn btn-lg btn-success waves-effect waves-light"><i class="mdi mdi-plus" style="margin-right:10px"></i>Add Entry</a>
                        </div>
                    </div>
                            ...
                            <table id="qaListTable" class="table  table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="vertical-align: middle;">NFT NAME</th>
                                        <th style="vertical-align: middle;">LINK</th>
                                        <th width="10%" style="vertical-align: middle;">STATUS</th>
                                        <th width="30%" style="vertical-align: middle;">PHOTO</th>
                                ...
                                <tbody>
                                    <?php if(sizeof($datalist)!=0):?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <img style="max-width:200px;max-height:200px" <?= ($row['photo'] != '') ? "src='data:image/jpg;charset=utf8;base64," . base64_encode($row['photo']) . "'" : "src='" . base_url() ."/public/assets/images/img_placeholder.png'" ?> >
                                                </div>
                                            </td>
                                            <td>
                                                <div class="button-items">
                                                    <a title="Detail" class="btn btn-primary waves-effect waves-light" href="<?= base_url('NFTCatalog/Detail/'.$row['nft_catalog_id']) ?>">
                                                    <i class="mdi mdi-information"></i>
                                                    </a>
                                                    <a title="Edit" class="btn btn-warning waves-effect waves-light" href="<?= base_url('NFTCatalog/Edit/'.$row['nft_catalog_id']) ?>">
                                                    <i class="mdi mdi-lead-pencil"></i>
                                                    </a>
                                                    <?php if($row['status']=='Y'):?>
                                                        <button type="button" data-href="<?= base_url('NFTCatalog/Delete/'.$row['nft_catalog_id']) ?>" onclick="confirmToDelete(this)" class="btn btn-danger waves-effect waves-light">
                                                        <i title="Active/Non-Active" class="mdi mdi-trash-can"></i>
                                                        </button>
                                                    <?php else:?>
                                                        <button type="button" data-href="<?= base_url('NFTCatalog/Delete/'.$row['nft_catalog_id']) ?>" onclick="confirmToDelete(this)" class="btn btn-success waves-effect waves-light">
