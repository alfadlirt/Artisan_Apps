...
<?= $this->section('content'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                <form method="GET" action="<?=base_url('Robot/index');?>">
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    <div class="row" style="margin-top:50px">
                        <div class="col-md-3">
                            <a href="<?= base_url('Robot/New') ?>" class="btn btn-lg btn-success waves-effect waves-light"><i class="mdi mdi-plus" style="margin-right:10px"></i>Add Entry</a>
                        </div>
                    </div>
                            ...
                            <table id="qaListTable" class="table  table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="10%" style="vertical-align: middle;">RBT CODE</th>
                                        <th width="10%" style="vertical-align: middle;">RBT NAME</th>
                                        <th style="vertical-align: middle;">RBT DESC</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="button-items">
                                                    <a title="Detail" class="btn btn-primary waves-effect waves-light" href="<?= base_url('Robot/Detail/'.$row['rbt_id']) ?>">
                                                    <i class="mdi mdi-information"></i>
                                                    </a>
                                                    <a title="Edit" class="btn btn-warning waves-effect waves-light" href="<?= base_url('Robot/Edit/'.$row['rbt_id']) ?>">
                                                    <i class="mdi mdi-lead-pencil"></i>
                                                    </a>
                                                    <?php if($row['status']=='Y'):?>
                                                        <button type="button" data-href="<?= base_url('Robot/Delete/'.$row['identifier']) ?>" onclick="confirmToDelete(this)" class="btn btn-danger waves-effect waves-light">
                                                        <i title="Active/Non-Active" class="mdi mdi-trash-can"></i>
                                                        </button>
                                                    <?php else:?>
                                                        <button type="button" data-href="<?= base_url('Robot/Delete/'.$row['identifier']) ?>" onclick="confirmToDelete(this)" class="btn btn-success waves-effect waves-light">
